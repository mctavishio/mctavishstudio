	...
	return {
		language: {
			texts: {
				...
				cmpb: ["bells", "forged ", "armaments", "wells",  "trains ", "intersect", "watch", "clocks", "synchronized ", "birdland", "heat", "angels", "worn suitcases", "shoes", "ghosts", "sandwiches", "rivers", "burn", "timetables", "the carbon cycle", "photosynthetic swarm", "electric body", "cybernetic queen", "boat", "waves rise", "water", "glass", "steel", "iron", "brick", "concrete", "canvas", "tent cities", "shops", "red", "electric lanterns", "satellites", "pulse", "night", "broken crowns", "looms", "woven", "metallic chords", "counterpoint", "frictions", "collisions", "temples", "echo", "armament bells", "signs", "clouds", "birds", "smoke", "two", "one", "quickly none", "unfettered", "photosynthetic fields", "just this ...", "dusty window pane", "low rumble", "tracks", "gears", "tunnels", "telegraph messages", "radio signals", "sine waves", "atomic counterpoint", "siren symphonies", "sensory skulls", "crows", "neon signs", "wheels", "race", "horses", "rivers", "particles", "beaded necklace", "repeat repeat", "velocity", "geologies", "artifacts", "archeologies", "an imprint", "skull", "feather", " shell", "crimson", "arrow", "circuits", "near / far", "distance", "rhythmic time", "generative", "over & over & over", "time", "luminous", "sunrise", "reed", "pitch", "wire", "wood", "bone", "hands", "breath ", "feathers", "ecologies", "elemental flows", "transference", "transformation", "carbon exchange", "water", "(s)","industry!", "pipelines", "smokestack symphony", "chalky death", "bones", "xylophone bones ", "bird", "suitcase", "sandwich", "tent city", "horizon", "agent", "captain", "turn back", "worker", "rusty gear", "switch", "undo undo", "terminals", "last stop", "last station", "sine waves", "bells || struck", "metal || scraped", "horsehair || wire", "breath || reed", "passion", "last passenger", "skeletal", "keys", "boneyard", "fugue", "weave", "loom", "fabric", "cloth", "networked", "cybernetic queen", "electric ze", "photosynthetic", "satellites", "transmissions", "coordinates", "cables", "limbs", "info", "rope", "mast", "honey", "swarm", "hymnal hum", "compute", "machines", "swift", "calculation", "churn", "tapes", "coded", "transmissions", "prayers", "astroid", "messengers", "intelligence", "forged", "fractured", "spent", "knit ", "capitulated", "transmigration", "telegraph", "message", "window", "broken", "code", "urgent", "angels", "witness", "crows", "reversals", "tune", "cast", "forge", "sacrifice", "risk", "cathedrals", "stone", "centuries", "swift", "boat", "flight", "migrations", "flight", "walk", "timetables", "bulletin", "boats", "trains", "away", "current", "torrent", "catalyst", "rise", "web", "whale", "turn back", "net", "carbon", "count", "retrieve", "forest", "birds", "insects", "chorus", "electric", "pulse", "cacophonous", "threads", "web", "bread", "wind", "tent city sailors", "turbulence", "storm", "ink", "hymn", "elegy", "orchestration", "light", "sound", "energy", "artifact", "archeologies", "traces", "imprints ", "fossil ", "record", "static", "fabric", "stitch", "suture", "silence", "zero", "noise", "one", "two", "none ", "conductor", "junction", "switch", "climb ", "foothold", "flow", "flood", "spill", "stain", "howl", "night mail", "train", "late", "package", "sandwich", "coffee", "birdland", "suitcase", "& waited", "hour", "clock", "over & over", "hands", "circled", "rim of stars", "lattice", "warp", "improvisation", "compass", "navigation", "time", "space", "circuitous", "encompass", "elemental", "fusions", "metal", "horsehair", "wood", "reed", "pitch", "hands", "breath", "tap", "scrape", "pull", "metal", "weave", "lost", "cycles", "dispersions", "collisions", "spheres", "evolutions", "probabilities", "clouds", "silence", "cloud", "swarm", "light", "weave", "knot", "mend", "bend", "tie", "ahab", "warehouse", "dreams", "words", "in the beginning", "libraries", "texts", "scribed", "density", "deviance", "light", "photosynthesis", "chlorophyl", "bone", "fields", "rye", "maps", "arteries", "shifts", "dynamics", "webs", "bones", "buildings", "tonalities", "ladders", "paper ", "ink", "fire", "architectures", "draw", "sine waves", "light", "sound", "melding particles into waves", "beat beat tone", "generative", "instruments", "cello", "loom", "drawing machine", "food webs", "ecologies", "constellations", "threads", "material", "transmigration", "carbon", "animate", "de - compose", "energy", "atomic", "electrons", "transfer", "chordal", "astronomies ", "zoom", "circles", "open", "permeable", "porous", "tapping glass", "liminal", "thresholds", "porous", "intimate", "boundaries ", "human", "tapping glass ", "carbon cycle", "cyborg body", "fragile", "electric body ", "resistance", "cyborg ", "digits", "hive", "mind ", "the swarm", "sinew", "grids", "networks", "scores,  ", "labyrinths", "webs", "looms", "rivers", "torrents", "geometries", "topologies", "chordal", "echo", "friction", "fray", "fluid", "flow,", "sine waves", "static", "body", "hand", "wood", "pitch", "bone", "sinew", "membrane", "horse hair", "resin", "reed", "breath", "wire", "pigment ", "graphite ", "digits", "electrical", "currents", "radio", "transmissions", "artifacts", "rooms", "there is an elliptical quality ", "to space & time", "landscapes", "lines", "again & again & again", "morning", "arc", "wingspan", "flight", "pulse", "infinity", "change", "evolutions", "revolutions", "grids", "train tracks", "timetables", "clocks", "tickets ", "sandwiches", "industry!", "ceaseless", "string", "wire", "reed", "wood", "pitch", "resonance", "echo", "sanctuary", "cage", "flock", "choir", "regiment", "sound", "stain", "permeate", "algorithms", "tracks ", "gepetto", "workshop ::: ", "lyrical", "intelligence ", "forever", "chance", "fever", "last bird", "charcoal", "rising up", "solar gods ", "weather", "planes", "flight", "trains", "ritual", "conceal & reveal / ", "imprint & erasure / ", "resistance", "persistence", "sky ", "birdland", "infinite", "transitions", "fluid", "marks", "echo", "arc", "records", "artifacts", "imprints", "archeologies", "techno lover", "network", "cloud", "being / she", "cybernetic s/ze :::", "touch", "tap", "friction", "strum", "web", "generators", "filters", "transformers", "glass", "wires", "waves ", "electric", "trace", "embraced", "subsumed", "consumed ", "digital", "fugal", "cyber-orchestra ", "poet", "machine", "singer", "draw", "factory ", "machine", "surveillance", "oZ ", "industry!", "footsteps", "paths ", "my queries :::", "imprint", "iris", "forsaken", "rhythms", "systems", "structures", "mathematical", "experiments", "scores", "orchestrations", "choreographies", "maps", "count", "ze", "(en)coded", "(m)bodied", "scripts ", "blueprints", "contours of change", "geographies", "movement", "convergences", "divergences", "emergence", "cascades", "impacts ", "complexity ", "tension ", "bounds", "interconnected", "webs", "polyphony", "architectures ", "streams", "rivers", "torrents ", "loosely-coupled", "reactive web", "generators", "filters", "transformers", "digital", "cyber", "orchestration", "fugue", "counterpoint", "web", "network", "code", "literature", "pattern", "language", "score", "choreography", "performance", "renderer ", "weaver", "mill", "alchemist", "wizard", "incantation ", "code", "activation", "text", "linguistic", "gymnastics", "chance", "open", "improvise", "system(s)", "frayed", "stochastic", "cloud", "pointillist", "field", "deviance", "variance", "complexity", "uncertainty", "(s) ", "ragged", "jagged", "torn", "stitch", "thread(s)", "line", "dreams", "liminal", "theory", "abstraction", "map", "sensory skull", "heart", "animal", "particle", "sine waves", "self", "cave wall", "shadows", "pattern", "rhythm", "pulse ", "way", "path", "spine", "know", "sense", "frame", "listen", "contours", "world", "wide", "web", "immersion", "time", "space", "traversals", "vectors", "flight", "door", "window", "blue window ", "clock", "flame", "moth", "every morning", "data", "created", "data", "collected", "morning", ". . .", "digit", "count", "map", "pulse", "breathe", "heart", "extinction	", "death", "honey", "vial", "traces", "algorithms", "body", "memory", "engine", "data", "watch", "heart beat", "coordinates", "velocities", "heat", "body", "dimensions", "measures", "movement", "change", "to be human", "numbers", "twisted", "strand", "blood", "remember", "AIDS", "epidemic", "performance", "(s)", "blood", "courses", "spilled", "flung", "drawn", "tested", "virus", "tentacular", "reach", "fill", "expand", "cellular", "resistance", "street", "word", "noise", "forces", "physics", "contours", "loss", "heart beats", "lifetimes", "flex", "pulse", "breathe", "spectacular", "tentacular", "death", "house", "memory", "last bird", "embalments", "industry!", "open", "hand", "vial", "coordinates", "here", "now", "function", "filter", "map", "clockworks", "metrics", "time"]
			},
			playlists: {
