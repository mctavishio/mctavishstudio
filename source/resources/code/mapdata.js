	...
	return {
		language: {
			...
			playlists: {
				...
				cmpbtalk: ["nouns","verbs","adj","symbols"],
				cmpbtalknoun: ["nouns"],
				cmpbtalkverb: ["verbs"],
				cmpbtalkadj: ["adj"],
				cmpbtalksymbol: ["symbols"],
			}
		},
		colors: {
			pigments: {
		...
		sounds: {
			...
			playlists: {
				...
				cmpbtalk: [
					...
					["weatherradio1", "train", "fan", "surf"],
					["piano1low"], [ "piano1random"], ["knocking1"], ["piano1"],
