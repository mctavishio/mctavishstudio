module.exports = () => {
	...
	points.forEach( ( point, j ) => {
		...
		path.pathpoints.push( {
			...
			title: "a coming together ::: the mill", subtitle: "text ::: Hawona Sullivan Janzen <br/> mix ::: Kathy McTavish", 
			content: "<h5>welcome! </h5><p class='small'>Turn on sound by tapping the audio button above.<br/>To hide this text panel tap the eye button in the upper left.<br/>To view the vimeo version of the whole ::: the confluence ::: <a href='https://vimeo.com/402029996/9947e38740' title='link to vimeo version'>click here.</a><br/>View in full screen or open two browsers to experience a duet.<br/>You can read the full poem below.<br/>Thank you ... for being our community. Thank you for supporting us.<br/>love ... love ... love ... all love ...</p><hr/><h5 class='center'>a coming together</h5><p class='center'>you are but one part of this<br/>what is it?<br/>it was nothing at first <br/>we had seen it before<br/>the frustration<br/>degradation<br/>instigation<br/>separation<br/>we had seen it all before <br/>an emergence<br/>a loop<br/>a bitmapped process, perhaps<br/>a solitary thing<br/>a sound a sound a sound<br/>then <br/>a formless form<br/>urging the other forms <br/>to get into formation <br/>a convergence<br/>we had seen it before <br/>you are but one part <br/>of this weather system <br/>uncommon in its commonness<br/>a reminder of what happens when nothing else is happening<br/>but we still can't sleep<br/>on the brink of this convergence<br/>there was a granular component <br/>a technicolored tidal wave <br/>a growing <br/>a shifted mass <br/>of us <br/>at first static <br/>then growling <br/>and pawing<br/>and feeding <br/>then tipping dipping flipping<br/>then dancing <br/>we were lost <br/>but never fearful<br/>we always saw the after  <br/>there was a respite <br/>then<br/>a coming together <br/>a coming together<br/>a coming together <br/>...something like a howl<br/></p><hr/><h5>ingredients :::</h5><p class='small'>Spoken / whispered text by Hawona, fragments of sound from Kathy's composers residency with Zeitgeist New Music, a sung note from Mags David, a tornado siren in the distance, weather radio, a train, the breathe, sine waves, a bell ... code.</p>", 
