	...
	let path = 
	{
		...
		links: [
			...
			},
			{
				actuate: "onrequest", type: "external", //internal, external
				format: "html", keywords: ["reference"],
				title: "journal 2020.07.07", uri: "", url: "https://mctavish.studio/atlas20200707.html",
				action: "traverse"
			},
			{
				actuate: "onrequest", type: "external", //internal, external
				format: "html", keywords: ["reference"],
				title: "journal 2020.07.08", uri: "", url: "https://mctavish.studio/atlas20200708.html",
				action: "traverse"
			},
			{
				actuate: "onrequest", type: "external", //internal, external
